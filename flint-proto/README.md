...
Shared packet types and mesh routing primitives for the KindleSense sensor
network.
...
| `KindlePayload` | Enum of all application-layer message types |
