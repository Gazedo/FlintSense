# bridge-control Specification

## Purpose

Defines how the host controls the `flint-bridge` output mode over the USB serial
link, including the binary/debug mode command channel and the behaviour of each
mode.
