# bridge-frame-protocol Specification

## Purpose

Defines the self-delimiting binary record protocol that `flint-bridge` emits over
USB serial and that `flint-gateway` decodes, including framing, integrity checks,
decoded frame reports, raw frame reports, and frame disposition.
